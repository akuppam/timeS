...
# -------------------------------------------------------------------------
# -------------------------------------------------------------------------
fit6 <- prophet(holidays = holidays, yearly.seasonality = yearly.seasonality) %>% 
  fit.prophet(pdat)
...
# ets() can't handle data with frequency greater than 24. 
# ets() ignores seasonality - so use stlf() if you need seasonal forecasts.
# -------------------------------------------
# -------------------------------------------
# HoltWinters
