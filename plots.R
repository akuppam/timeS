...
df_all <- data.frame(dfreal,dfprophet,dfprophet_visits,dfprophet_br,dfprophet_vibr,dfprophet_vibrli,dfprophet_brli,df1,df6,df11)
names(df_all) <- c("real","prophet","prophet_visits","prophet_br","prophet_vibr","prophet_vibrli","prophet_brli","ets","arima","hw")
